...
string[] du_facts = {
    "The University of Denver is abbreviated as 'DU'",
...
while (true)
{
    ...
    prompt = $"Reply in a conversational manner utilizing mainly the top facts from the vector database. Be a friendly but concise chatbot to help users learn more about the University of Denver. Query: {query}\n";
