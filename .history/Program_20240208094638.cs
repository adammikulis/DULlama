...
while (true)
{
    ...
    prompt = $"Reply in a conversational manner utilizing mainly the top facts in the prompt to answer only the user's specific question. Be a friendly but concise (do not offer extra, less related info) chatbot to help users learn more about the University of Denver. Query: {query}\n";
